...
namespace ProyectoHexactaAPI.Models
{
    public class Persona
    {
        ...
        public int Edad()
        {
            DateOnly edad = DateOnly.FromDateTime(DateTime.Today)
                .AddYears(-AnioNacimiento)
                .AddMonths(-MesNacimiento)
                .AddDays(-DiaNacimiento);
            return edad.Year;
        }
